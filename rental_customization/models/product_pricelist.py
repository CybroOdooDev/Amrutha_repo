...
class PriceList(models.Model):
        ...
        def generate_pricelists(self):
            ...
            pricelists_data = [
                ...
                # GRN
                {
                    ...
                    "ranges": [(0, 0)],
                    "products": [
                        {"product_ref": "PS10", "recurrence_ref": "M28", "price": 110},
                        {"product_ref": "PS20", "recurrence_ref": "M28", "price": 110},
                        {"product_ref": "PS20DD", "recurrence_ref": "M28", "price": 120},
                        {"product_ref": "PS20HC", "recurrence_ref": "M28", "price": 130},
                        {"product_ref": "PS20M", "recurrence_ref": "M28", "price": 320},
                        {"product_ref": "PS20MC", "recurrence_ref": "M28", "price": 290},
                        {"product_ref": "PS40", "recurrence_ref": "M28", "price": 130},
                        {"product_ref": "PS40DD", "recurrence_ref": "M28", "price": 140},
                        {"product_ref": "PS40HC", "recurrence_ref": "M28", "price": 150},
                        {"product_ref": "PS40HCDD", "recurrence_ref": "M28", "price": 155},
                        {"product_ref": "PS40M", "recurrence_ref": "M28", "price": 420},
                        {"product_ref": "PS40MC", "recurrence_ref": "M28", "price": 350},
                        {"product_ref": "PS45HC", "recurrence_ref": "M28", "price": 150},
                        {"product_ref": "PS48HC", "recurrence_ref": "M28", "price": 160},
                        {"product_ref": "RE20", "recurrence_ref": "M28", "price": 0},
                        {"product_ref": "RE30", "recurrence_ref": "M28", "price": 0},
                        {"product_ref": "SBBIZFEE", "recurrence_ref": "M28", "price": 2},
                        {"product_ref": "SBLOSSWAV-20OF", "recurrence_ref": "M28", "price": 30},
                        {"product_ref": "SBLOSSWAV-40OF", "recurrence_ref": "M28", "price": 40},
                        {"product_ref": "SBLOSSWAV-STCO", "recurrence_ref": "M28", "price": 15},
                        {"product_ref": "SBLOSSWAV-STTR", "recurrence_ref": "M28", "price": 25},
                        {"product_ref": "SBLOT", "recurrence_ref": "M28", "price": 20},
                        {"product_ref": "SBLTOSACQ", "recurrence_ref": "M28", "price": 0},
                        {"product_ref": "ST4596", "recurrence_ref": "M28", "price": 150},
                        {"product_ref": "ST48102", "recurrence_ref": "M28", "price": 150},
                        {"product_ref": "ST53102", "recurrence_ref": "M28", "price": 175},
                    ]
                },
                # ICT
                {
    ...
    #                     "transportation_rate": rate,
    #                 })
    #             # Create new range line if it doesn't exist
    #             else:
    #                 self.env["distance.range.line"].create([{
    #                     "pricelist_id": pricelist.id,
    #                     "name": [(6, 0, product_ids)],
